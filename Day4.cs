...
namespace BCA_B1_207
{
    public class Day4
    {
        static void Main(string[] args)
        {
            ...
            // It will give you boolean output, either true or false
            ...
            Console.WriteLine(num2 >= 20); // True
            Console.WriteLine(num2 > 20); // False
            ...
            Console.WriteLine(num2 == 20 && num2 > 20 && num1 == 10);
